...
TEST_CASE("fn_wrappers can be combined by logical-and's") {
    ...
    auto const expectations = std::map<int, bool>{
        {0, false}, {1, false}, {2, false}, {3, true}, {4, true}, {5, true}, {6, false}, {7, false}, {8, false},
    };

    for (auto const &[input, expected_output] : expectations) {
...
TEST_CASE("fn_wrappers can be combined by logical-or's") {
    ...
    auto const expectations = std::map<int, bool>{
        {0, false}, {1, true}, {2, false}, {3, false}, {4, true}, {5, false}, {6, false}, {7, false}, {8, false},
    };
...
TEST_CASE("fn_wrappers can be combined by logical-and's and logical-or's") {
    ...
    auto const expectations = std::map<int, bool>{
        {0, false}, {1, false}, {2, false}, {3, true}, {4, true}, {5, true}, {6, false}, {7, false}, {8, true},
    };
